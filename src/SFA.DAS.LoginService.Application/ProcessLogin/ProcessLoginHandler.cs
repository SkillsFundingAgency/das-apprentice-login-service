    ...
    public async Task<ProcessLoginResponse> Handle(ProcessLoginRequest request, CancellationToken cancellationToken)
    {
      ...
      if (!signInResult.Succeeded)
      {
        ...
        return signInResult.IsLockedOut
            ...
            : new ProcessLoginResponse() { Message = "Make sure you have entered the correct email address and password. If you have forgotten your password you can reset it by selecting 'change your password' below." };
      }
